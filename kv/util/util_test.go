...
func TestBoolFromValue(t *testing.T) {
	require.True(t, BoolFromValue(mem.NewValue(0, &commonpb.BoolProto{Value: true}), "key", false))
	require.False(t, BoolFromValue(mem.NewValue(0, &commonpb.BoolProto{Value: false}), "key", true))

	require.True(t, BoolFromValue(mem.NewValue(0, &commonpb.Float64Proto{Value: 123}), "key", true))
	require.False(t, BoolFromValue(mem.NewValue(0, &commonpb.Float64Proto{Value: 123}), "key", false))
...
func TestUpdateBoolWithValue(t *testing.T) {
	...
	vw.Update(mem.NewValue(0, &commonpb.BoolProto{Value: false}))
	<-w.C()
	...
	vw.Update(mem.NewValue(0, &commonpb.BoolProto{Value: true}))
	<-w.C()
	UpdateBoolWithValue(w.Get(), "foo", &testConfig.v, &testConfig.RWMutex, true, nil)
	testConfig.Lock()
	...
	vw.Update(mem.NewValue(0, &commonpb.Float64Proto{Value: 20}))
	<-w.C()
	UpdateBoolWithValue(w.Get(), "foo", &testConfig.v, &testConfig.RWMutex, true, nil)
	testConfig.Lock()
	require.True(t, testConfig.v)
...
func TestFloat64FromValue(t *testing.T) {
	require.Equal(t, 20.5, Float64FromValue(mem.NewValue(0, &commonpb.Int64Proto{Value: 200}), "key", 20.5))
	require.Equal(t, 123.3, Float64FromValue(mem.NewValue(0, &commonpb.Float64Proto{Value: 123.3}), "key", 20))
...
func TestInt64FromValue(t *testing.T) {
	require.Equal(t, int64(200), Int64FromValue(mem.NewValue(0, &commonpb.Int64Proto{Value: 200}), "key", 20))
	require.Equal(t, int64(20), Int64FromValue(mem.NewValue(0, &commonpb.Float64Proto{Value: 123}), "key", 20))
...
func TestUpdateInt64WithValue(t *testing.T) {
	...
	vw.Update(mem.NewValue(0, &commonpb.Int64Proto{Value: 20}))
	<-w.C()
	...
	// mimic a bad value update, should fall back to default
	vw.Update(mem.NewValue(0, &commonpb.Float64Proto{Value: 100}))
	<-w.C()
...
func TestStringArrayFromValue(t *testing.T) {
	...
	require.Equal(t, v1, StringArrayFromValue(mem.NewValue(0, &commonpb.StringArrayProto{Values: v1}), "key", defaultValue))
	require.Equal(t, defaultValue, StringArrayFromValue(mem.NewValue(0, &commonpb.Float64Proto{Value: 123}), "key", defaultValue))
...
func TestUpdateStringArrayWithValue(t *testing.T) {
	...
	v1 := []string{"s1", "s2"}
	vw.Update(mem.NewValue(0, &commonpb.StringArrayProto{Values: v1}))
	<-w.C()
...
func TestUpdateTimeWithValue(t *testing.T) {
	...
	vw.Update(mem.NewValue(0, &commonpb.Int64Proto{Value: t1.Unix()}))
	<-w.C()
